    ...
    return (
        <div className="slides-birthday-container">
            <div className="slides-birthday-box">
                ...
                {currentSlide ? <img alt="image" src={currentSlide.text_03} className="slides-birthday-image-announcement"/> : <div className="slides-birthday-image-announcement">Insert Image 2</div>}
