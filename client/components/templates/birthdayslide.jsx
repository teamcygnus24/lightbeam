    ...
    return (
        <div className="thumbnail-container">
            <div className="slides-slide-box">
                ...
                {currentSlide ? <img src={currentSlide.text_02} className="imagePerson"/> : <div className="imagePerson">Insert Image</div>}
                {currentSlide ? <img src={currentSlide.text_03} className="imageAnnouncement"/> : <div className="imageAnnouncement">Insert Image 2</div>}
